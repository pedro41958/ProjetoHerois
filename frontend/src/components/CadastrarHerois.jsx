...
export default function CadastrarHeroi({ fecharModal }) {
  ...
  return (
    <div className="fixed inset-0 bg-black/50 flex flex-col items-center justify-center shadow-md h-screen">
      ...
      >
        ...
        <h2 className="text-x1 font-bold mb-4">Dados da Umamusume</h2>
        ...
        <label htmlFor="url_imagem" className="text-center">
          Foto de perfil:
          <input
            type="url"
            name="url_imagem"
        ...
        <label htmlFor="id_guilda" className="text-center">
          Time:
          <select
            name="id_guilda"
            onChange={handleChange}
